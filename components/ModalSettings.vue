          ...
          b-tab-item(label="Estilo" icon="palette-swatch-outline")
            b-field(label='Estilo de fondo')
              b-select(v-model='bgStyle')
                option(v-for='option in bgStyles' :value='option.value' :label="option.label" :key='option.value' :mobile-modal="false")
            b-field(label='Estilo de botones')
              b-select(v-model='buttonType' )
                option(v-for='option in buttonTypes' :value='option.value' :label="option.label" :key='option.value' :mobile-modal="false")
            b-field(label='Estilo de lista de botones')
              b-select(v-model='listButtonType' )
                option(v-for='option in listButtonTypes' :value='option.value' :label="option.label" :key='option.value' :mobile-modal="false")
